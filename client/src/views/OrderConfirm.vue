<template>
    ...
    <div>
      <HeadNav/>
      <zhanghao><span>订单确认</span></zhanghao>
      ...
      <div class="container">
        <div class="checkout-order">
          <div class="page-title-normal">
            <h2 class="page-title-h2"><span>支付</span></h2>
          </div>
          <!-- process step -->
  ...
  export default {
    ...
    methods:{
      ...
      payMent(){
          ...
          this.$http.post("/users/payMent",{addressId:this.$route.query.addressId,orderTotal:this.orderTotal}).then(res=>{
